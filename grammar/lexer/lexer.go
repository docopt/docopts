// imported from github.com/alecthomas/participle/lexer
package lexer
...
// format as Go code string
func (t Token) GoString() string {
	return fmt.Sprintf("Token{Type: %d, Regex_name: %q, Value: %q}", t.Type, t.Regex_name, t.Value)
}
